...
Create a new file in the project root directory (in the outer project folder where the README.md file is **not** in the `src` directory) called `.env`. Yes, this file's name starts with a dot (`.`)! Make sure you name it **_exactly_** as you see it here.
...
- Create options for the user to change the number of images to return; 
...
- Create options for the user to change the rating of the images;
